...
@if (employee_data(auth()->user()->id, 'team_lead_id') == 'CEO')
            <div class="alert alert-info">
            You don't have access of this form
            </div>
@else
        @if (submission_status(auth()->user()->id) == 1)
            <div class="alert alert-info">
        ...
        <form action="{{ route('employee.feedback.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <label>Full Name</label>
                    <input type="text" name="name" class="form-control" readonly placeholder="Full Name" value="{{ auth()->user()->first_name.' '. auth()->user()->last_name }}" required>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Department</label>
                    <input type="text" name="department" class="form-control" readonly placeholder="Department" value="{{ employee_data(auth()->user()->id, 'department') }}" required>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Reporting Manager</label>
                    <input type="text" name="reporting_manager" class="form-control" readonly placeholder="Reporting Manager" value="{{ employee_data(auth()->user()->id, 'team_lead') }}" required>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Position</label>
                    <input type="text" name="position" class="form-control" readonly placeholder="Position" value="{{ employee_data(auth()->user()->id, 'position') }}" required>
                </div>
                <div class="col-md-2 mb-3">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input type="text" name="joining_date" class="form-control" readonly placeholder="Joining Date" value="{{ employee_data(auth()->user()->id, 'joining_date') }}" required>
                </div>
            </div>
            <br><br>
