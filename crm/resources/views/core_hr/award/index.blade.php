...
(function($) {
    ...
    $(document).on('click', '.show_new', function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                let photoHtml = "<img src='{{ URL::to('/public') }}/uploads/award_photos/" + result.data.award_photo + "' width='70' class='img-thumbnail' style='cursor: pointer;' onclick='showImagePreview(this.src)'>";
    ...
    function award_photo(id) {
        $.ajax({
            url: "{{ route('awards.index') }}/" + id + "/photo",
            dataType: "json",
            success: function (data) {
                let html = '';
                if (data.award_photo) {
                    html = `<img src="{{ URL::to('/public') }}/uploads/award_photos/` + data.award_photo + `" width="70" class="img-thumbnail" style="cursor: pointer;" onclick="showImagePreview(this.src)">`;
                } else {
                    html = `<img src="{{ asset('assets/images/default_photo.jpg') }}" width="70" class="img-thumbnail" style="cursor: pointer;" onclick="showImagePreview(this.src)">`;
                }
