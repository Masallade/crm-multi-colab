                ...
                @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="from_employee" id="from_employee" value="{{ auth()->user()->id }}">
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    // Check if current user is the ticket creator
                    if (html.data.from_employee != {{ auth()->user()->id }}) {
                        alert('{{__('You are not authorized to edit this ticket')}}');
                        return;
                    }
