...
class TransferController extends Controller {
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('description', 'company_id', 'from_department_id', 'to_department_id', 'employee_id', 'transfer_date', 'team_lead'
			),
				[
					'company_id' => 'required',
			...
			$employee->team_lead = (int)$request->team_lead;
			$employee->save();
