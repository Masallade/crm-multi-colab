...
<?php $__env->startPush('scripts'); ?>
    <script type="text/javascript">
        ...
        let roleId = "<?php echo e(Auth::user()->role_users_id); ?>"; // Get logged-in user's role ID
        ...
        var table_table = $('#file_manager-table').DataTable({
            ...
            columnDefs: [
                ...
                { 
                    render: function (data, type, row) {
                        if (type === 'display') {
                            return '<div class="form-check"><input type="checkbox" class="dt-checkboxes form-check-input"><label class="form-check-label"></label></div>';
                        }
                        return data;
                    },
                    checkboxes: {
                        selectRow: true,
                        selectAllRender: '<div class="form-check"><input type="checkbox" class="dt-checkboxes form-check-input"><label class="form-check-label"></label></div>'
                    },
                    targets: [0]
                }
            ],
            ...
            // ✅ Show export buttons only for role_users_id = 1 or 6
            buttons: roleId == 1 || roleId == 6 ? [
                {
                    extend: 'pdf',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/baselinepractice/public_html/v2/crm/resources/views/file_manager/file_manager.blade.php ENDPATH**/ ?>