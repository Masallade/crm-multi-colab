...
<div class="modal-dialog modal-fullscreen" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="chartModalLabel"><a href="{{ url('staff/employees') }}" class="btn btn-warning"  style="padding: 10px; text-decoration: none;">Back</a></h5>
            </div>
...
var data = {!! $jsonHierarchy ?? '[]' !!};
if (!Array.isArray(data) || data.length === 0) {
  document.getElementById('body').innerHTML = '<div style="padding:16px;font-size:14px;color:#666">No employees available to render the org chart.</div>';
  // Stop executing rest of the script when there is no data
  throw new Error('Org chart: no data');
}
var root = data[0];
// console.log(root_);
// console.log(root);
