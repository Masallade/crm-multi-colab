        ...
        <form method="POST" action="{{ route('getNewAppraisalType') }}">
            ...
            <div id="step2-container" style="display: none;">
                ...
                <div class="form-group">
                    <label for="designation_ids">{{__('Appraisal Designations')}}</label>
                    <select name="designation_ids[]" id="designation_ids" class="form-control selectpicker" 
                        ...
                        @foreach($designations as $designation)
                            ...
                            @endphp
                            <option value="{{ $designation->id }}" {{ $disabled }} data-content="{{ $designation->designation_name }}{{ $title }}{{ $isUsed ? ' <span class=\'text-danger\'>(Already assigned)</span>' : '' }}">
    ...
    designationIdsSelect.addEventListener('change', function() {
        ...
        selectedDesignations.forEach(designationId => {
            ...
            designationHeader.innerHTML = `
                <label>${designation.designation_name} - {{__('Choose Departments')}}</label>
                <select name="departments[${designationId}][]" class="form-control selectpicker department-select" 
                        multiple data-live-search="true" 
                        title="{{__('Select Departments for')}} ${designation.designation_name}...">
                </select>
            `;
            ...
            departmentSelect.addEventListener('change', function() {
                ...
                selectedDepartments.forEach(deptId => {
                    ...
                    sections.forEach(section => {
                        ...
                        label.textContent = '{{__("Select Evaluator")}}';
                        ...
                        emptyOption.value = '';
                        emptyOption.textContent = '{{__("Select Evaluator")}}';
                        ...
                        if (indicators.length > 0) {
                            ...
                            if (indicatorsList.children.length > 0) {
                                ...
                                indicatorsTitle.textContent = '{{__("Indicators")}}:';
