                ...
                <div class="container-fluid mb-3">
                    <div class="card">
                        <div class="card-header">
                            <h5><i class="fa fa-info-circle"></i> {{__('My Resignation Status')}}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
...
<script type="text/javascript">
    (function($) {
        ...
        $(document).on('click', '.hr_approve', function () {
            ...
            $.ajax({
                url: "{{ url('core_hr/resignations') }}/" + resignation_id + "/hr-approve",
                method: "POST",
                data: {
                    notes: notes,
        ...
        $(document).on('click', '.hr_reject', function () {
            ...
            $.ajax({
                url: "{{ url('core_hr/resignations') }}/" + resignation_id + "/hr-reject",
                method: "POST",
                data: {
                    notes: notes,
                    _token: $('input[name="_token"]').val()
        ...
        $(document).on('click', '.admin_approve', function () {
            ...
            $.ajax({
                url: "{{ url('core_hr/resignations') }}/" + resignation_id + "/admin-approve",
                method: "POST",
                data: {
                    notes: notes,
                    _token: $('input[name="_token"]').val()
        ...
        $(document).on('click', '.admin_reject', function () {
            ...
            $.ajax({
                url: "{{ url('core_hr/resignations') }}/" + resignation_id + "/admin-reject",
                method: "POST",
                data: {
                    notes: notes,
                    _token: $('input[name="_token"]').val()
