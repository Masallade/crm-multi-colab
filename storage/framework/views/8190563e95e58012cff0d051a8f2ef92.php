        ...
        <div class="table-responsive">
            <table id="employee-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(trans('file.Staff Id')); ?></th>
                    <th><?php echo e(trans('file.Gender')); ?></th>
                    <th><?php echo e(trans('file.Last Appraisal Date')); ?></th>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="text-bold">Last Appraisal Date </label>
...
<div class="modal fade" id="changeTeamLeadModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Select New Team Lead</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <input type="text" id="searchTeamLead" class="form-control" placeholder="Search for employee">
                <ul id="employeeList" class="list-group mt-2">
                    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="list-group-item employee-item" data-id="<?php echo e($employee->id); ?>"><?php echo e($employee->full_name); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="assignTeamLead">Assign New Team Lead</button>
            </div>
        </div>
    </div>
</div>
...
<script>
// Open modal and store the employeeId to be updated
$('#changeTeamLeadModal').on('show.bs.modal', function (e) {
    var employeeId = $(e.relatedTarget).data('id'); // Fixed here
    $('#assignTeamLead').data('id', employeeId); // Store for later
});

// Search filter for team lead list
$('#searchTeamLead').on('keyup', function() {
...
$('#assignTeamLead').click(function() {
    var newTeamLeadId = $('#employeeList .active').data('id');
    var employeeId = $(this).data('id'); // Fixed this
    if (!newTeamLeadId || !employeeId) {
        alert('Please select a new team lead.');
        return;
    }

    $.ajax({
        url: '/employees/' + employeeId + '/changeTeamLead',
        method: 'POST',
        data: {
            _token: '<?php echo e(csrf_token()); ?>',
            new_team_lead_id: newTeamLeadId
        },
        success: function(response) {
            location.reload(); // or show a toast
        }
    });
});
    ...
    $(document).ready(function () {
        ...
        var table_table = $('#employee-table').DataTable({
            ...
            columns: [
                ...
                { data: 'last_appraisal_date', name: 'last_appraisal_date' },
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/employee/index.blade.php ENDPATH**/ ?>