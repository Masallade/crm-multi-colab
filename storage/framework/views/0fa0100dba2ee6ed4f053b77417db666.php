...
<script type="text/javascript">
    (function($) {
        ...
        $(document).on('click', '#download_pdf', function() {
            ...
            if (attendance_date1 !== '' && attendance_date2 !== '' && company_id !== '' && employee_ids.length > 0) {
                let url = "<?php echo e(route('update_attendances.download_pdf')); ?>";
                let params = {
                    attendance_date1: attendance_date1,
                    attendance_date2: attendance_date2,
                    company_id: company_id,
                ...
                alert('<?php echo e(__('Please select all required fields')); ?>');
            }
        });
        ...
        $(document).on('click', '#download_csv', function() {
            ...
            if (attendance_date1 !== '' && attendance_date2 !== '' && company_id !== '' && employee_ids.length > 0) {
                let url = "<?php echo e(route('update_attendances.download_csv')); ?>";
                let params = {
                    attendance_date1: attendance_date1,
                    attendance_date2: attendance_date2,
                    company_id: company_id,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/timesheet/updateAttendance/index.blade.php ENDPATH**/ ?>