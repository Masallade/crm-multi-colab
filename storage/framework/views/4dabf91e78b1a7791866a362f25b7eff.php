...
<div class="container mt-4">
                    ...
                    <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody id="recordsTableBody">
                                <?php $__empty_1 = true; $__currentLoopData = $offDeskRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="record-row">
                                    <td class="employee-name"><?php echo e($record->employee->first_name); ?> <?php echo e($record->employee->last_name); ?></td>
                                    <td><?php echo e(date('Y-m-d', strtotime($record->attendance_date))); ?></td>
                                    <td><?php echo e($record->clock_in); ?></td>
                                    <td><?php echo e($record->clock_out ?? 'N/A'); ?></td>
                                    <td><?php echo e($record->message); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('off_desk_hours.destroy', $record->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                            <?php echo csrf_field(); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
                    <form method="POST" action="<?php echo e(route('off_desk_hours.store')); ?>" id="offDeskForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date" id="date" class="form-control" max="<?php echo e(date('Y-m-d')); ?>" min="<?php echo e(date('Y-m-d', strtotime('-7 days'))); ?>" value="<?php echo e(date('Y-m-d')); ?>" required>
...
<script>
    $(document).ready(function() {
        ...
        function fetchShiftInfo(employeeId, date) {
            $.ajax({
                url: '<?php echo e(route("get_employee_shift")); ?>',
                method: 'GET',
                data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/crm/resources/views/timesheet/attendance/off_desk_hours.blade.php ENDPATH**/ ?>