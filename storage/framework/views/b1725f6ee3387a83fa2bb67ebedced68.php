                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="loan_type_id" required id="loan_type_id"
                                        ...
                                        title='<?php echo e(__('Selecting',['key'=>trans('file.Loan Option')])); ?>...'>
                                    <?php $__currentLoopData = $loanTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/employee/salary/loan/index.blade.php ENDPATH**/ ?>