...
<?php $__env->startSection('title_front','Job-Details'); ?>
        ...
        <div class="col-md-4 offset-md-1 mt-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"><?php echo e($job_post->jobExperience->title); ?></p>
...
<?php echo $__env->make('frontend.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/crm/resources/views/frontend/jobs/details.blade.php ENDPATH**/ ?>