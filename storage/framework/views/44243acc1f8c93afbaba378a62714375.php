                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="deduction_type_id" required id="deduction_type_id"
                                        ...
                                        title='<?php echo e(__('Select Deduction Option')); ?>'>
                                    <?php $__currentLoopData = $deductionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/employee/salary/deduction/index.blade.php ENDPATH**/ ?>