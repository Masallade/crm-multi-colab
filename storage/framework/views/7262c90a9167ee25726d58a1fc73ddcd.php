                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="evaluationMatrixBody_<?php echo e($section['id']); ?>">
                                ...
                                <?php if(!empty($departmentIds)): ?>
                                    <?php $__currentLoopData = $departmentIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deptId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td>
                                                <select name="sections[<?php echo e($section['id']); ?>][evaluators][]" class="form-select evaluator-dropdown">
                                                    ...
                                                    <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($employee->id); ?>" <?php echo e((isset($evaluatorIds[$index]) && $evaluatorIds[$index] == $employee->id) ? 'selected' : ''); ?>>
...
</script><?php /**PATH D:\project\Laravel\crm-multi-colab-Dawood\resources\views/settings/variables/partials/appraisal_partials/sections.blade.php ENDPATH**/ ?>