            ...
            <table id="date_wise_attendance-table" class="table ">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(__('Late Sitting')); ?></th>
...
<?php $__env->startPush('scripts'); ?>
    ...
    // Sum only time columns (7 to 10)
    for (let i = 7; i < 11; i++) {
        datatable_sum(api, i);
    }

    // Handle percentage (column index 11) separately
    var totalPercentage = 0;
    var count = 0;

    api.column(11, { page: 'current' }).nodes().each(function (cell, i) {
        var val = $(cell).text().replace('%', '').trim();
        if ($.isNumeric(val)) {
    ...
    var avg = count > 0 ? (totalPercentage / count).toFixed(2) + '%' : '0%';
    $(api.column(11).footer()).html(avg);
}
,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/timesheet/dateWiseAttendance/index.blade.php ENDPATH**/ ?>