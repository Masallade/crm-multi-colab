<?php $__env->startSection('content'); ?>
    ...
    <?php if(session()->has('error')): ?>
        <div class="alert alert-danger" id="error-alert"><?php echo e(session('error')); ?></div>
    <?php endif; ?>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <ul class="nav nav-tabs d-flex justify-content-between" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link " href="#" id="one_day_hours-tab" data-toggle="tab" data-target="#one_day_hours" role="tab" aria-controls="one_day_hours" aria-selected="false"><?php echo e(__('One Day (Hours & Minutes)')); ?></a>
                    </li>
                    <li class="nav-item">
...
<!-- updated dawood add: appraisal type -->
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="pt-0 tab-pane fade" id="one_day_hours" role="tab" aria-labelledby="one_day_hours-tab">
              <?php echo $__env->make('settings.variables.partials.one_day_hours', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/settings/variables/index.blade.php ENDPATH**/ ?>