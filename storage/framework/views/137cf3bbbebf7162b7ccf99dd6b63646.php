...
var table_table = $('#deposit_category-table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "<?php echo e(route('deposit_category.index')); ?>",
    },
    columns: [
        {
            data: 'name',
...
$('#deposit_category_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "<?php echo e(route('deposit_category.store')); ?>",
        method: "POST",
...
$(document).on('click', '.deposit_category_edit', function () {
    ...
    var target = "<?php echo e(route('deposit_category.index')); ?>/" + id + '/edit';
    $.ajax({
        url: target,
        dataType: "json",
...
$('#deposit_category_edit_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "<?php echo e(route('deposit_category.update')); ?>",
        method: "POST",
...
$(document).on('click', '.deposit_category_delete', function () {
    ...
    let target = "<?php echo e(route('deposit_category.index')); ?>/" + delete_id + '/delete';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/settings/variables/JS_DT/deposit_category_js.blade.php ENDPATH**/ ?>