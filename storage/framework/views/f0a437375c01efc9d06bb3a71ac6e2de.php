                ...
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="from_employee" id="from_employee" value="<?php echo e(auth()->user()->id); ?>">
...
<script type="text/javascript">
    (function($) {
        ...
        // Check for toast message in session storage on page load
        ...
        // Show toast message if exists in session storage
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    // Check if current user is the ticket creator
                    if (html.data.from_employee != <?php echo e(auth()->user()->id); ?>) {
                        alert('<?php echo e(__('You are not authorized to edit this ticket')); ?>');
                        return;
                    }
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/crm/resources/views/SupportTicket/index.blade.php ENDPATH**/ ?>