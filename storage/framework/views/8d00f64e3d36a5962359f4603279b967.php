$(document).ready(function () {
    ...
    $('#updateLeaveButton').on('click', function () {
        ...
        $('.allocated-day, .remaining-allocated-day').each(function () {
            ...
            let allocatedDay = $('select.allocated-day[data-employee-id="' + employeeId + '"][data-leave-type-id="' + leaveTypeId + '"]').val();
            let remainingDay = $('select.remaining-allocated-day[data-employee-id="' + employeeId + '"][data-leave-type-id="' + leaveTypeId + '"]').val();
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/crm/resources/views/settings/variables/JS_DT/addEmployee_leave_js.blade.php ENDPATH**/ ?>