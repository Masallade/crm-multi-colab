    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function sendMessage(message) {
                ...
                // Send to server
                console.log('Sending message to:', '<?php echo e(route("ahham.chat")); ?>');
                console.log('Message:', message);
                
                fetch('<?php echo e(route("ahham.chat")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/layout/ahham.blade.php ENDPATH**/ ?>