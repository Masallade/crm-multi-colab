...
var table_table = $('#company_type-table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "<?php echo e(route('company_type.index')); ?>",
    },
    columns: [
        {
            data: 'type_name',
...
$('#company_type_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "<?php echo e(route('company_type.store')); ?>",
        method: "POST",
...
$(document).on('click', '.company_type_edit', function () {
    ...
    var target = "<?php echo e(route('company_type.index')); ?>/" + id + '/edit';
    $.ajax({
        url: target,
        dataType: "json",
...
$('#company_type_edit_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "<?php echo e(route('company_type.update')); ?>",
        method: "POST",
...
$(document).on('click', '.company_type_delete', function () {
    ...
    let target = "<?php echo e(route('company_type.index')); ?>/" + delete_id + '/delete';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/settings/variables/JS_DT/company_type_js.blade.php ENDPATH**/ ?>