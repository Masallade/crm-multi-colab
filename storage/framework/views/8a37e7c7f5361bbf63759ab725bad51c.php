...
var table_table = $('#job_experience-table').DataTable({
    ...
    serverSide: true,
    ajax: {
        url: "<?php echo e(route('job_experience.index')); ?>",
    },
    columns: [
        {
            data: 'title',
...
$('#job_experience_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "<?php echo e(route('job_experience.store')); ?>",
        method: "POST",
...
$(document).on('click', '.job_experience_edit', function () {
    ...
    var target = "<?php echo e(route('job_experience.index')); ?>/" + id + '/edit';
    $.ajax({
        url: target,
        dataType: "json",
...
$('#job_experience_edit_submit').on('click', function (event) {
    ...
    $.ajax({
        url: "<?php echo e(route('job_experience.update')); ?>",
        method: "POST",
...
$(document).on('click', '.job_experience_delete', function () {
    ...
    let target = "<?php echo e(route('job_experience.index')); ?>/" + delete_id + '/delete';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/settings/variables/JS_DT/job_experience_js.blade.php ENDPATH**/ ?>