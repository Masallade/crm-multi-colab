...
unset($__errorArgs, $__bag); ?>
                    ...
                    <br>
                        <button type="submit" class="button" onclick="playNotificationSound()">
                            <?php echo e(__('Login')); ?>
...
<script type="text/javascript">
    ...
    document.getElementById('login-form').addEventListener('submit', function(e) {
        // The form will still submit normally, we just want to play the sound
        playNotificationSound();
    });
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/auth/login.blade.php ENDPATH**/ ?>