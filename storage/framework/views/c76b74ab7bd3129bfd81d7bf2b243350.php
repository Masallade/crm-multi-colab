<div class="container-fluid">
    <div class="card mb-0">
        <div class="card-body">
            <h3 class="card-title"><?php echo e(__('Add Deduction Type')); ?></h3>
            <form method="post" id="deduction_type_form" class="form-horizontal" >
                <?php echo csrf_field(); ?>
                <div class="input-group">
                    <input type="text" name="deduction_type_name" class="form-control" placeholder="<?php echo e(__('Deduction Type')); ?>">
                    <input type="submit" id="deduction_type_submit" class="btn btn-success" value=<?php echo e(trans("file.Save")); ?>>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="deduction_type_form_edit" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-6 form-group">
                        <label><?php echo e(__('Deduction Type')); ?> *</label>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="deduction_type_edit_submit" id="deduction_type_edit_submit" class="btn btn-success" value=<?php echo e(trans("file.Edit")); ?> />
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/settings/variables/partials/deduction_type.blade.php ENDPATH**/ ?>