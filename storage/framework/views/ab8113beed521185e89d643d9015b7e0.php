                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <label class="text-bold">Team Lead</label>
                                                    <select name="teamlead" id="teamlead" class="selectpicker form-control"
                                                            ...
                                                            <?php $__currentLoopData = $team_lead; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($team->id); ?>" 
                                                                    <?php echo e($employee->team_lead == $team->id ? 'selected' : ''); ?>>
                                                                    <?php echo e($team->first_name . ' ' . $team->last_name); ?>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="date" name="last_appraisal_date" id="last_appraisal_date"
                                                            placeholder="Last Appraisal Date"
                                                             class="form-control"
                                                            value="<?php echo e($employee->last_appraisal_date); ?>">
                                                </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <select name="office_shift_id" id="office_shift_id"
                                                                ...
                                                                data-live-search="true"
                                                                data-live-search-style="contains"
                                                                title="<?php echo e(__('Selecting',['key'=>'Office Shift'])); ?>...">
...
<div class="col-md-4 form-group">
    ...
    <input 
        ...
        value="<?php echo e($employee->joining_date ? \Carbon\Carbon::parse($employee->joining_date)->format('d-m-Y') : null); ?>">
</div>
...
<div class="col-md-4 form-group">
    ...
    <input 
        ...
        autocomplete="off" 
        class="form-control date"
        value="<?php echo e($employee->probation_period ? \Carbon\Carbon::parse($employee->probation_period)->format('d-m-Y') : null); ?>">
</div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="exit_date" id="exit_date"
                                                            class="form-control date"
                                                               value="<?php echo e($employee->exit_date ? \Carbon\Carbon::parse($employee->exit_date)->format('d-m-Y') : null); ?>">
                                                    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/urtasker_crm/resources/views/employee/dashboard.blade.php ENDPATH**/ ?>